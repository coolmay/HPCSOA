    ...
    public static DataClient getDataClient(String dataClientId) throws DataException
    {
        synchronized (lockDataServerInfoInitialized)
        {
            if (!bDataServerInfoInitialized) {
                String strDataServerInfo = Environment.getEnvironmentVariable(Constant.SoaDataServerInfoForLinuxEnvVar);
                if (strDataServerInfo == null ){
	                strDataServerInfo = Environment
