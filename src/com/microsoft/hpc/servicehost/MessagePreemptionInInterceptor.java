...
public class MessagePreemptionInInterceptor extends AbstractSoapInterceptor {
    ...
    public void handleMessage(SoapMessage message) throws Fault {
        ...
        ServiceContext.Logger.traceEvent(Level.INFO, "MessagePreemptionInInterceptor : handle inbound message :" + message.toString());
        ...
        if (this.hpcHostWrapper.receivedCancelEvent) {
            ...
            ServiceContext.Logger.traceEvent(Level.INFO, "MessagePreemptionInInterceptor : messageUuid=" + messageUuid);
